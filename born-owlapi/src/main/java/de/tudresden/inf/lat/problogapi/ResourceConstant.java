...
public interface ResourceConstant {
	...
	String TEMPORARY_INPUT_FILE_FOR_PROBLOG = BORN_WORKING_DIRECTORY + FILE_SEPARATOR
			+ "temporary_input_for_problog.txt";

	String DEFAULT_INPUT_FILE_FOR_PROBLOG = BORN_WORKING_DIRECTORY + FILE_SEPARATOR + "input_for_problog.txt";

	String DEFAULT_OUTPUT_FILE_FROM_PROBLOG = BORN_WORKING_DIRECTORY + FILE_SEPARATOR + "output_from_problog.txt";
