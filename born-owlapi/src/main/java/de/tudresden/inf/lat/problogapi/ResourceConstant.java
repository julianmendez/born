...
public interface ResourceConstant {
	...
	String PROBLOG_OUTPUT_FILE = BORN_WORKING_DIRECTORY + FILE_SEPARATOR + "temporary_input_for_problog.txt";

	String INPUT_FILE_FOR_PROBLOG = BORN_WORKING_DIRECTORY + FILE_SEPARATOR + "input_for_problog.txt";
