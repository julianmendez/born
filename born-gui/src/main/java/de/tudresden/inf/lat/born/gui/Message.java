...
public interface Message {
	...
	String tooltipTextFieldOutputFile = "select the output gile";

	String tooltipOpenInputOntologyFile = "opens an input ontology file";

	String tooltipComputeInference = "compute inference";
	String textThreshold = "threshold";
	String tooltipTextFieldThreshold = "threshold";
	String textMaxNumberOfVar = "max number of vars";
